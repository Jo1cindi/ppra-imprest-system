    ...
    if (receiptDetails) {
      axios({
        ...
        .then((response) => {
          ...
          setAccountantName(
            response.data[0][0].firstName + " " + response.data[0][0].lastName
          );
        })
        .catch((error) => {
          console.log(error);
  ...
  const searchReceipt = () => {
    const searchResult = receipts[0].filter((receipt) => {
      ...
      return (
        ...
        receipt.amount_requested.toString().match(searchQuery.toString())
      );
    });
        ...
        <>
          {receiptDetails && (
            <div className="receiptDetails">
              <IoCloseSharp
                ...
                onClick={() => setReceiptDetails(false)}
              />
                ...
                <div id="receiptCardContent">
                  ...
                  <div className="requestSummary">
                    ...
                    <div className="allrequestSummary">
                      <p>
                        <strong>Request Number: </strong> {requestId + 5}
                      </p>
                      <p>
                        <strong>Reason for Request: </strong> {reason}
                      </p>
                      <p>
                  ...
                  <div className="fundAllocationSummary">
                    ...
                    <div className="fundsAllocationOutput">
                      <p>
                        <strong>Fund Allocation Status: </strong> approved
                      </p>
                      <p>
                        <strong>Date Allocated:</strong> {receiptSummary[1]}
                      </p>
                    </div>
                  </div>
          ...
          <div className="allReceipts">
            ...
            <div className="receiptList">
              {notSearching === true || searchQuery === " "
                ? receipts[0].map((receipt, index) => (
